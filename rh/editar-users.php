                        ...
                        <div class="card-body">
                            ...
                            <form class="forms-sample">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="nome-usuario-edit"
                                           value="<?php echo $u['NOME_FUNC'] ?>" id="nome-usuario-edit" required>
                                    <input type="hidden" class="form-control" name="nome-usuario-edit"
                                           value="<?php echo $u['id'] ?>" id="id-usuario-edit" required>
                                    <span id="cvnome">Campo Vazio!</span>
                                </div>
                                <div class="form-group">
                                    <label for="usu_nome">E-mail</label>
                                    <input type="email" class="form-control" name="email-usuario-edit"
                                           id="email-usuario-edit" value="<?php echo $u['email'] ?>" required>
                                    <span id="cvemail">Campo Vazio!</span>
                                    <span id="cvemailV">Endereço de e-mail inválido!</span>
                                </div>
                                <div class="form-group">
                                    <label for="experienciaCad_desc">CPF</label>
                                    <input type="text" class="form-control" value="<?php echo $u['cpf'] ?>" name="cpf"
                                           id="cpf-usuario-edit" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="dp-usuario-edit" required>
                                        ...
                                        <?php foreach ($d as $itens): ?>
                                            <option <?php echo($itens['id'] == $u['id_departamento'] ? ' selected' : '') ?>
                                                    value="<?php echo $itens['id'] ?>">
                                                <?php echo $itens['nome'] ?>
                                            </option>
                                        ...
                                        <div class="col-sm-4">
                                            <div class="form-check">
                                                <label class="form-check-label">
                                                    <input type="radio" class="form-check-input" name="membergerente"
                                                           id="membershipRadios1"
                                                           value="1" <?php echo($u['flag_gestor'] != 0 || $u['flag_gestor'] != "" ? ' CHECKED' : '') ?>
                                            ...
                                            <div class="form-check">
                                                <label class="form-check-label">
                                                    <input type="radio" class="form-check-input" name="membergerente"
                                                        ...
                                                        <?php echo($u['flag_gestor'] == 0 || $u['flag_gestor'] == "" ? ' CHECKED' : '') ?>
                                                           value="0">
                                                    Não
                                                    <i class="input-helper"></i></label>
                                            </div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" id="searchusu_gestorD" class="form-control"
                                                       name="search"

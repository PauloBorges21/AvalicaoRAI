...
$ativo = false;
$u = $usuario->getAllFDesativados($ativo);
...
<div class="main-panel">
    <div class="content-wrapper">
        <div class="col-12 grid-margin">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Usuário desativados no sistema</h4>
...
<!--                                                                </a>-->
                                                                <button type="button" id="delete-button" data-id="<?php echo $tbItens['id'] ?>" class="btn btn-primary btn-sm">Ativar</button>
                                                            </td>
                                                        </tr>
                                                    <?php endforeach; ?>
                                                </tbody>
...
<script>
    ...
    buttons.forEach(button => {
        ...
        function desativaUsuario(iduser) {
            $.ajax({
                url: "ajax/ajax-reativa-usuario.php",
                method: "POST",
                dataType: "json",
                data: {
                    usuario: iduser,

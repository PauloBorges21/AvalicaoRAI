...
var canvasArray = [
    {
        campo: "barChartdp",
        url: "../rh/ajax/ajax-grafico-cultural-dp.php",
    },
];
...
if ($("#criaPDF").length) {
    document.getElementById("criaPDF").addEventListener('click', function () {
        ...
        var canvasArray = [
            "BarContratarChartOpt",
            "BarInspirarChartOpt",
            "BarFalarChartOpt",
            "BarEscutarChartOpt",
            "BarAgradecerChartOpt",
            "BarDesenvolverChartOpt",
            "BarCuidarChartOpt",
            "BarCompartilharChartOpt",
            "BarCelebrarChartOpt"
        ];
        var imagesObject = {};
        var tipopg = {tipo:3};
...
async function creatChart(obj) {
    ...
    let modelos = [
        ...
        {id: 4, nome: 'Escutar'},
        {id: 5, nome: 'Agradecer'},
        {id: 6, nome: 'Desenvolver'},
        {id: 7, nome: 'Cuidar'},
        {id: 8, nome: 'Compartilhar'},
        {id: 9, nome: 'Celebrar'},
    ];
